...
<body>
  ...
  <header>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link" href="index - kadai.php">ブックマーク登録</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="select - kadai.php">ブックマーク一覧</a>
          </li>
        </ul>
      </div>
    </nav>
  ...
  <form method="post" action="update - kadai.php">
